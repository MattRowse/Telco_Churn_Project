...
This report has been prepared for the edX HarvardX: PH125.9x capstone requirement and the data is available from Kaggle [here](https://www.kaggle.com/blastchar/telco-customer-churn?select=WA_Fn-UseC_-Telco-Customer-Churn.csv).
